    ...
    return (
      <div className="p-4 sm:p-8 flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <p className="text-muted-foreground text-sm mb-4">There was an error fetching employee data.</p>
          <button
            onClick={() => refetch()}
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-foreground px-4 py-2 rounded-lg text-sm font-medium transition-all"
          >
        ...
        <div className="p-4 border-b border-border flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <div className="relative max-w-xs w-full">
            ...
            <input
              ...
              className="w-full rounded-lg border border-border bg-background/50 pl-10 pr-4 py-2.5 text-sm text-foreground placeholder-muted-foreground focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors"
            />
          </div>
          <button
            onClick={() => refetch()}
            disabled={isFetching}
            className="flex items-center gap-2 bg-secondary hover:bg-secondary text-foreground px-3 py-2 rounded-lg text-sm font-medium transition-colors disabled:opacity-50"
          >
